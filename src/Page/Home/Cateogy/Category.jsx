    ...
    return (
        <div>
            ...
            >
                ...
                <SwiperSlide className='ml-7'><img className='w-full h-96 object-cover' src={slider3} alt="this is a slider image" /> <p className='uppercase text-4xl text-white  -mt-16 text-center '>pizzas</p></SwiperSlide>
                <SwiperSlide className='ml-7'><img className='w-full h-96 object-cover' src={slider4} alt="this is a slider image" /> <p className='uppercase text-4xl text-white  -mt-16 text-center '>desserts</p></SwiperSlide>
